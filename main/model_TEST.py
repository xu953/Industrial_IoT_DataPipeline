...
if __name__ == "__main__":
    model_path = "model/20220330_074343_lab9_anomaly_fan" # model file directory, you must change this!
    model = tf.keras.models.load_model(model_path) # load the model from the path above
    threshold =  0.030563 # float: threshold (MAE loss) for the ML model
    min_val =  -1.24545   # float: minimum value for normalization
    max_val =  20.08402   # float: maximum value for normalization
